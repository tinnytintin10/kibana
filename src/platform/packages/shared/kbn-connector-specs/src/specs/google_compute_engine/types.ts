...
const ZONE_PATTERN = /^[a-z]+-[a-z]+[0-9]-[a-z]$/;
...
export const GetOperationInputSchema = lazySchema(() =>
  z.object({
    ...
    operationName: z
      .string()
      .max(128)
      .regex(/^operation-[A-Za-z0-9-]+$/, {
        message: 'Must be an operation name as returned by a mutating action',
      })
      .describe(
        'The operation name returned by a mutating action, for example "operation-1234-...".'
      ),
    zone: zone()
      .optional()
      .describe(
